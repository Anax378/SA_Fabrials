...
public class SprenCatchingStationMenu extends AbstractContainerMenu {
    private final SprenCatchingStationBlockEntity blockEntity;
    private final Level level;

    public SprenCatchingStationMenu(int containerId, Inventory inv, FriendlyByteBuf extraData){
    ...
    public SprenCatchingStationMenu(int containerId, Inventory inv, BlockEntity entity) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 21, 33));
            this.addSlot(new SlotItemHandler(handler, 1, 102, 33));
            this.addSlot(new SlotItemHandler(handler, 2, 142, 33));
        });
    }
